...
| Cache fairness | `[cache] max_anchors_per_session` (default 4), `max_anchor_bytes_per_session` (default 0/disabled), `session_idle_ttl_ms` (default 900000), or matching `CLAP_CACHE_*` variables; automatic checkpoints count toward the total anchor cap |
