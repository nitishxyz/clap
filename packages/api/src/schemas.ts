...
export const clapVersion = "0.2.2";
...
export const LoadedModelSchema = z.object({
  ...
  worker: z.object({
    ...
    residency: z.object({
      ...
      estimateSource: z.enum(["prior_observation", "model_artifacts", "architecture_metadata", "configured_cache", "cache_components", "context_configuration", "conservative_fallback"]).nullable(),
    ...
    memory: z.object({
      activeBytes: z.number().int().nonnegative().nullable(),
      activeBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      activeBytesBasis: z.string().min(1).optional(),
      cacheBytes: z.number().int().nonnegative().nullable(),
      cacheBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      cacheBytesBasis: z.string().min(1).optional(),
      peakActiveBytes: z.number().int().nonnegative().nullable(),
      peakActiveBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      peakActiveBytesBasis: z.string().min(1).optional(),
    }).optional(),
    retention: z.object({
      ...
      retainedBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      retainedBytesBasis: z.string().min(1).optional(),
      sessionBytes: z.number().int().nonnegative().nullable(),
      sessionBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      sessionBytesBasis: z.string().min(1).optional(),
      anchorBytes: z.number().int().nonnegative().nullable(),
      anchorBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      anchorBytesBasis: z.string().min(1).optional(),
      evictedBytes: z.number().int().nonnegative().nullable().optional(),
      evictedBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      evictedBytesBasis: z.string().min(1).optional(),
      estimatedRetainedBytes: z.number().int().nonnegative().nullable().optional(),
      estimatedRetainedBytesSource: z.enum(["measured", "estimated", "unavailable"]).optional(),
      estimatedRetainedBytesBasis: z.string().min(1).optional(),
      ...
      sessionPolicyEvictions: z.number().int().nonnegative().optional(),
      sessionBudgetRejections: z.number().int().nonnegative().optional(),
      anchorPublications: z.number().int().nonnegative().optional(),
      anchorPublicationSkips: z.number().int().nonnegative().optional(),
      expiredSlots: z.number().int().nonnegative().optional(),
      expiredAccountedBytes: z.number().int().nonnegative().optional(),
      releasedSessionSlots: z.number().int().nonnegative().optional(),
      releasedSessionAccountedBytes: z.number().int().nonnegative().optional(),
      anchorAccountedBytes: z.number().int().nonnegative().optional(),
      maxAnchorBytesPerSession: z.number().int().nonnegative().optional(),
      sessionIdleTtlMs: z.number().int().nonnegative().optional(),
    }).optional(),
